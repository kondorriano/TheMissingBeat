...
function FixedUpdate() {
	...
	// New Way
	var nextStep : float  = transform.eulerAngles.z + rigidbody.angularVelocity.z*Time.fixedDeltaTime;
    var nextRotation : float = nextAngle - nextStep;
 	...
 	if (nextRotation*sentido < 0) {
 		...
 		rigidbody.angularVelocity.z = 0;
	  	...
	  	rigidbody.angularVelocity.z = Mathf.Lerp(rigidbody.angularVelocity.z, desiredAngularVelocity, Time.fixedDeltaTime*speed/10);
